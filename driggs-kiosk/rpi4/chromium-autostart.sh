...
root@parents-kiosk:/home/driggs# sudo nano /var/lib/dietpi/dietpi-software/installed/chromium-autostart.sh
root@parents-kiosk:/home/driggs# cat /var/lib/dietpi/dietpi-software/installed/chromium-autostart.sh
#!/bin/dash
# Autostart script for kiosk mode, based on @AYapejian: https://github.com/MichaIng/DietPi/issues/1737#issue-318697621
...
# Command line switches: https://peter.sh/experiments/chromium-command-line-switches/
# - Review and add custom flags in: /etc/chromium.d
CHROMIUM_OPTS="--disable-gpu --kiosk --window-size=${RES_X:-1280},${RES_Y:-720} --window-position=0,0"
